...
import { $isCodeBlockNode } from '@mdxeditor/editor'
import { codeBlockLanguages$, getCodeBlockLanguageSelectData } from '@mdxeditor/editor'
import { activeEditor$, editorInFocus$, useTranslation } from '@mdxeditor/editor'
import { Select } from '.././primitives/select'

// Mirrors @mdxeditor/editor's internal codemirror EMPTY_VALUE sentinel (not part of its
// public API, but getCodeBlockLanguageSelectData's returned items use this exact value).
