...
import { BlockType, activePlugins$, convertSelectionToNode$, currentBlockType$, useTranslation } from '@mdxeditor/editor'
import { allowedHeadingLevels$ } from '@mdxeditor/editor'
