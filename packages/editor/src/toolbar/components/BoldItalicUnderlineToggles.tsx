import { applyFormat$, currentFormat$, iconComponentFor$, useTranslation } from '@mdxeditor/editor'
import { useCellValues, usePublisher } from '@mdxeditor/gurx'
import React from 'react'
import { FORMAT, IS_BOLD, IS_ITALIC, IS_STRIKETHROUGH, IS_SUBSCRIPT, IS_SUPERSCRIPT, IS_UNDERLINE } from '@mdxeditor/editor'
import { ToggleSingleGroupWithItem } from '../primitives/toolbar'
import { TextFormatType } from 'lexical'
import styles from '../ui.module.css'
import { IconKey } from '@mdxeditor/editor'
