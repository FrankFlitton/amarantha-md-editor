...
import { EditorInFocus, editorInFocus$, readOnly$, useTranslation } from '@mdxeditor/editor'
...
function isConditionalContentsOption(option: ConditionalContentsOption | FallbackOption): option is ConditionalContentsOption {
  // Object.hasOwn needs an ES2022 lib target; this repo's consuming packages don't all set one.
  return Object.prototype.hasOwnProperty.call(option, 'when')
}
